...
export class SidebarComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (token) {
            ...
            this.userPermisions = decodedToken["Permission"] || [];

            this.userPermisions = Array.isArray(this.userPermisions) ? this.userPermisions : [this.userPermisions];
    ...
    hasPermission(menu: MenuItem): boolean {
        if (menu.permision) {
            return menu.permision.some(r => this.userPermisions.includes(r));
        } else {
            return true;
        }
    }
